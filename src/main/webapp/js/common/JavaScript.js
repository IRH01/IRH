...
function mOver(){
document.getElementById('div_btn1').src="/images/btn_05.gif";
	
	}
	function mOut(obj){
	obj.style.backgroundImage = "url(../images/btn_03.gif)";
	
	}
	
function change_bg(obj)
{
    var a=document.getElementById("NavMenu").getElementsByTagName("a");
...
$(document).ready(function()
{
	...
	{
		$(this).find("li").stop(true,true).slideDown(100);},function(){$(this).find("li").stop(true,true).slideUp(100)
...
$(document).ready(function()
{
	$("#NavMenu li ul li").click(function()
	{
		$(this).parent().parent().siblings().children("a").css("background","url(../images/btn_05.gif)");
		$(this).parent().parent().children("a").css("background","url(../images/btn_03.gif)");
	});
	
	$("#NavMenu li:first").click(function()
	{
		$(this).siblings().children("a").css("background","url(../images/btn_05.gif)");
		$(this).children("a").css("background","url(images/btn_03.gif)");
	});
});
...
document.onclick=function(e){
    ...
    var o = e.srcElement || e.target;
     if(calendar.dateControl != o) calendar.hide();
}